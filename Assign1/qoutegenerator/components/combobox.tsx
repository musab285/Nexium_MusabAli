...
export function ComboboxDemo({value, onChange, topic}: ComboboxDemoProps) {
  ...
  const quotes = data.filter((quote: Quote) => quote.topic === topic);
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-full justify-between hover:shadow-md hover:bg-gray-100 transition duration-300 ease-in-out font-light font-mono"
        >
          {value
